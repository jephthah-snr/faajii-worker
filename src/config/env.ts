...
const jobSchema = z.object({
  ...
  digestSnapshotPath: z.string().startsWith("/").optional(),
});
...
const schema = z.object({
  ...
  TOOLING_API_KEY: z.string().default(""),
...
export const config = {
  ...
  smsAllowedCountryCodes: new Set(
    raw.SMS_ALLOWED_COUNTRY_CODES.split(",").map((x) => x.trim())
  ),
} as const;
